...
if (!$product_gallery_template && !$porfolio_gallery_template){
$blog_temp="true";
get_header(); 
$this_is_blog=true;
?>
...
<div class="content sub">
		...
		$more = 0;
		if($cat || $tag){
			$query_string = "showposts=".get_option('rttheme_blog_pager')."&cat=$cat&tag=$tag&paged=$paged";
		   ...
		   <?php if (have_posts()) : while (have_posts()) : the_post();?>
				...
				<!-- blog box-->
					<div class="box blog">
							...
							<p>
								<?php the_excerpt(); ?>
								<a href="<?php echo get_permalink() ?>" title=""  class="read_more">leer más</a>
							</p>
							<!-- /blog text-->
